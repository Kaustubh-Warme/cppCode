...
void FriendNetwork::findMaxMinComments() {
    int maxComments = INT8_MIN, minComments = INT8_MAX;
...
void FriendNetwork::DFS(int startUserId) {
    ...
    cout << "DFS Traversal starting from " << users[startUserId].name << ": ";
...
int doMenu() {
    ...
    cout << "2. Whose post has maximum comments and minimum comments?" << endl;
